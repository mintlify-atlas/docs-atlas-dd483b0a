...
<ParamField path="NEXT_PUBLIC_SUPABASE_ANON_KEY" type="string" required>
  Your Supabase anonymous (public) key. Found in the Supabase dashboard under **Settings → API → Project API Keys → anon public**.
  
  This is a public variable. It is safe to expose in the browser — access is governed by Row Level Security policies.
</ParamField>
